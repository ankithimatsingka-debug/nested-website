      ...
      <div className="container px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4">
            <span className="text-secondary">SuperFD</span> Products
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8">
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                <Card
                  className={`relative overflow-hidden bg-gradient-to-br ${product.gradientFrom} ${product.gradientTo} border ${product.borderColor} p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full`}
                >
                  {/* Popular Badge */}
                  {product.isPopular && (
